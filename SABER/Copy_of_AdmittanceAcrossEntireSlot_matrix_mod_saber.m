function [Admittance] = AdmittanceAcrossEntireSlot_matrix_mod_saber(slot_2_x_dist, slot_1_x_dist, slot_seperation, frequency)
%old  [Admittance] = AdmittanceAcrossEntireSlot_matrix_mod_saber(slot_2_x_dist, slot_1_x_dist, slot_1_y_dist, slot_2_y_dist, slot_seperation, frequency)
...
%% General Constants %%zero for center or design frequency
% lambda0 = 3E8/frequency0;
% u_0 =  (1.25663706E-6);
% omega0 = 2*pi*frequency0;
% k0 = 2*pi/lambda0;

%% General Constants %% analysis frequency
