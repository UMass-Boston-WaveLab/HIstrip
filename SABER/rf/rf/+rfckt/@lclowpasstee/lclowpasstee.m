classdef (CaseInsensitiveProperties,TruncatedProperties)                ...
        lclowpasstee < rfckt.ladderfilter
%rfckt.lclowpasstee class
%   rfckt.lclowpasstee extends rfckt.ladderfilter.
%
%    rfckt.lclowpasstee properties:
...
%
%    rfckt.lclowpasstee methods:
%       checkproperty - Check the properties of the object.
%       createntwk - Create LC lowpass tee ladder filter network



    methods  % constructor block
        function h = lclowpasstee(varargin)
        %LCLOWPASSTEE Constructor.
        %   H = RFCKT.LCLOWPASSTEE('L', VALUE1, 'C', VALUE2) returns an LC
        %   lowpass tee filter object, H, based on the properties specified
        ...
        %
        %   An LC lowpass tee filter object has the following properties.
        ...
        %   'help rfckt.lclowpasstee/<METHOD>', where METHOD is one of the
        %   methods listed above. For instance,
        %   'help rfckt.lclowpasstee/plot'.
        %
        %   Example:
        %
        %      % Create an LC lowpass tee filter
        %        h = rfckt.lclowpasstee('C', [1e-12 4e-12], 'L',        ...
        %            [2e-9 2.5e-9])
        ...
        %   RFCKT.LCHIGHPASSTEE, RFCKT.LCLOWPASSPI, RFDATA
          
        %   Copyright 2003-2010 The MathWorks, Inc.

        %UDD % h = rfckt.lclowpasstee;
        set(h, 'Name', 'LC Lowpass Tee');
        ...
        switch nargin
            case 0
                % Set default L and C
                set(h, 'L', [1.3324e-5  1.3324e-5], 'C', 1.1327e-9);
            otherwise
