classdef (CaseInsensitiveProperties,TruncatedProperties) ...
        parallel < rfckt.network
%rfckt.parallel class
%   rfckt.parallel extends rfckt.network.
%
%    rfckt.parallel properties:
...
%       nwa - Calculate the network parameters.
    ...
    methods  % constructor block
        ...
        %   H = RFCKT.PARALLEL('CKTS', {CKT1, CKT2, ...}) returns a
        %   parallel connected network object, H, which contains a cell of
        %   2-port RFCKT objects: CKT1, CKT2, ...
        %   The default CKTS is empty. 
        %
        %   A parallel RFCKT object has the following properties. All the
        ...
        %   'help rfckt.parallel/<METHOD>', where METHOD is one of the
        %   methods listed above. For instance, 'help rfckt.parallel/plot'.
        %
        %   Example:
        %
        %      % Construct a parallel RFCKT object
        %        h = rfckt.parallel('Ckts', {rfckt.txline('LineLength', ...
        ...
        %                                        ZY Smith chart
        %
        %   See also RFCKT, RFCKT.CASCADE, RFCKT.SERIES, RFCKT.HYBRID,
        %   RFCKT.HYBRIDG, RFDATA
        
        %   Copyright 2003-2015 The MathWorks, Inc.

        %UDD % h = rfckt.parallel;
        set(h,'Name','Parallel Connected Network');
