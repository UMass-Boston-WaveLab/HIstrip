classdef (CaseInsensitiveProperties,TruncatedProperties)                ...
        lchighpasspi < rfckt.ladderfilter
%rfckt.lchighpasspi class
%   rfckt.lchighpasspi extends rfckt.ladderfilter.
%
%    rfckt.lchighpasspi properties:
...
%       createntwk - Create LC highpass pi ladder filter network
    ...
    methods  % constructor block
        ...
        %   H = RFCKT.LCHIGHPASSPI('L', VALUE1, 'C', VALUE2) returns an LC
        %   highpass pi filter object, H, based on the properties specified
        ...
        %
        %   An LC highpass pi filter object has the following properties.
        ...
        %   'help rfckt.lchighpasspi/<METHOD>', where METHOD is one of the
        %   methods listed above. For instance,
        %   'help rfckt.lchighpasspi/plot'.
        %
        %   Example:
        %
        %      % Create an LC highpass pi filter
        %        h = rfckt.lchighpasspi('C', [1e-12 4e-12], 'L',        ...
        %            [2e-9 2.5e-9])
        ...
        %   RFCKT.LCBANDSTOPPI, RFCKT.LCBANDSTOPTEE, RFCKT.LCHIGHPASSTEE,
        %   RFCKT.LCLOWPASSPI, RFCKT.LCLOWPASSTEE, RFDATA
        
        %   Copyright 2003-2010 The MathWorks, Inc.
        
        %UDD % h = rfckt.lchighpasspi;
