classdef (CaseInsensitiveProperties,TruncatedProperties)                ...
        lclowpasspi < rfckt.ladderfilter
%rfckt.lclowpasspi class
%   rfckt.lclowpasspi extends rfckt.ladderfilter.
%
%    rfckt.lclowpasspi properties:
...
%       createntwk - Create LC lowpass pi ladder filter network
    ...
    methods  % constructor block
        ...
        %   H = RFCKT.LCLOWPASSPI('L', VALUE1, 'C', VALUE2) returns an LC
        %   lowpass pi filter object, H, based on the properties specified
        ...
        %   'h = rfckt.lclowpasspi'. 
        %
        %   An LC lowpass pi filter object has the following properties.
        ...
        %   'help rfckt.lclowpasspi/<METHOD>', where METHOD is one of the
        %   methods listed above. For instance,
        %   'help rfckt.lclowpasspi/plot'.
        %
        %   Example:
        %
        %      % Create an LC lowpass pi filter
        %        h = rfckt.lclowpasspi('C', [1e-12 4e-12], 'L',         ...
        %            [2e-9 2.5e-9])
        ...
        %   RFCKT.LCHIGHPASSTEE, RFCKT.LCLOWPASSTEE, RFDATA
          
        %   Copyright 2003-2010 The MathWorks, Inc.

        %UDD % h = rfckt.lclowpasspi;
