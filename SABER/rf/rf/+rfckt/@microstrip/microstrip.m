classdef (CaseInsensitiveProperties,TruncatedProperties)                ...
        microstrip < rfckt.basetxline
%rfckt.microstrip class
%   rfckt.microstrip extends rfckt.basetxline.
%
%    rfckt.microstrip properties:
...
%       checkproperty - Check the properties of the object.
    ...
    methods  % constructor block
        ...
        %   H = RFCKT.MICROSTRIP('PROPERTY1', VALUE1, 'PROPERTY2',
        %   VALUE2, ...) returns a microstrip transmission line object, H,
        ...
        %   'h = rfckt.microstrip'. 
        %
        %   A microstrip object has the following properties. All the
        ...
        %   'help rfckt.microstrip/<METHOD>', where METHOD is one of the
        %   methods listed above. For instance,
        %   'help rfckt.microstrip/plot'.
        %
        %   Example:
        %
        %      % Create a microstrip transmission line
        %        h = rfckt.microstrip('Thickness',0.0075e-6)
        ...
        %   RFCKT.PARALLELPLATE, RFCKT.COAXIAL, RFCKT.CPW, RFDATA 
        
        %   Copyright 2003-2010 The MathWorks, Inc.

        %UDD % h = rfckt.microstrip;
        set(h, 'Name', 'Microstrip Transmission Line');
...
%SETER Set function for the dielectric constant.
...
if (out <= 1)
    ...
    error(message('rf:rfckt:microstrip:seter:LessThanOne', rferrhole));
end
end   % seter