classdef (CaseInsensitiveProperties,TruncatedProperties)                ...
        lcbandstoppi < rfckt.ladderfilter
%rfckt.lcbandstoppi class
%   rfckt.lcbandstoppi extends rfckt.ladderfilter.
%
%    rfckt.lcbandstoppi properties:
...
%       createntwk - Create LC bandstop pi ladder filter network
    ...
    methods  % constructor block
        ...
        %   H = RFCKT.LCBANDSTOPPI('L', VALUE1, 'C', VALUE2) returns an LC
        %   bandstop pi filter object, H, based on the properties specified
        ...
        %
        %   An LC bandstop pi filter object has the following properties.
        ...
        %   'help rfckt.lcbandstoppi/<METHOD>', where METHOD is one of the
        %   methods listed above. For instance,
        %   'help rfckt.lcbandstoppi/plot'.
        %
        %   Example:
        %
        %      % Create an LC bandstop pi filter
        %        h = rfckt.lcbandstoppi('C', [1e-12 4e-12], 'L',        ...
        %            [2e-9 2.5e-9])
        ...
        switch nargin
            case 0
                % Set default L and C
                set(h, 'L', [2.8091e-8  2.2603e-9  2.8091e-8], 'C',     ...
                    [1.8403e-12  2.2871e-11  1.8403e-12]);
            otherwise
