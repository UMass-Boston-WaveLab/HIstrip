function scc_params = s2scc(s_params, rfflag)
%S2SCC Convert 2N-port S-parameters to common-mode N-port S-parameters Scc
%   SCC_PARAMS = S2SCC(S_PARAMS, RFFLAG) coverts single-ended 2N-port
%   S-parameters to common-mode N-port S-parameters. 
%
%   S_PARAMS is a complex 2Nx2NxM array of M 2N-port single-ended
%   S-parameters. The output SCC_PARAMS is a complex NxNxM array of M
%   N-port common-mode S-parameters.
%
%   S2SCC uses one of 3 definitions of port indices for 2N-port
...
%      
%   See also S2SDD, S2SDC, S2SCD, SMM2S, S2SMM
...
[~, ~, ~, scc_params] = s2smm(s_params, rfflag);
