...
figure(1); 
plot(f*1e-9, f*1e-9*abs(C12)./(f*1e-9*10^(-12)),'linewidth',2);
hold on
plot(f*1e-9, f*1e-9*abs(C2G)./(f*1e-9*10^(-12)),'linewidth',2);
hold on
plot(f*1e-9, f*1e-9*abs(C12+C2G)./(f*1e-9*10^(-12)),'linewidth',2);
legend('C12','C2G','C12+C2G');
