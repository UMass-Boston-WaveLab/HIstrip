...
% matrices. See equations 47 - 51 in the paper.
...
% Calculate the ratio values (eqn. 48 and 49)
for ii = 1:depth
    ratio1(1,1,ii) = G20(1,1,ii)/G10(1,1,ii);
    ratio2(1,1,ii) = G20(2,2,ii)/G10(2,2,ii);
end

% Now find L10 and L20 values (eqn 49)
L10 = zeros(1,1,depth);
L20 = zeros(1,1,depth);
for ii = 1:depth
...
% Only one is needed; both are calculated as a check (eqn 50)
L12 = zeros(1,2,depth);
for ii = 1:depth
...
% Calculates the L0 matrix (eqn 51)
L0 = zeros(2,2,depth);
for ii = 1:depth
