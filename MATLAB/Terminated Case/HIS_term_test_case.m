...
[Cshalf, Cp, ~] = MTLcapABCD(h1, h2, w1, w2, eps1, eps2, (a-w2), f);
...
Zleft = terminate_ABCD4(Cshalf*Cp*MTL*Lmat*MTL, ZL_left);
Zleft = unitcellMultiply(Zleft, unitcell, (n/2)-1);

Zright = terminate_ABCD4(Cshalf*Cp*MTL*Lmat*MTL, ZL_right);
