function [ ABCD, gameig] = multicond_unitcell( a, w1, w2, h1, h2, via_rad, eps1, eps2, freq)
...
%this represents the wave impedance looking into the region of patches that
%are not covered by the microstrip line - the next row of patches over
ZblochP = getZblochPatches(L_via, Cgap, Cp, Z2, epseff2*omega/c, omega, w2);
