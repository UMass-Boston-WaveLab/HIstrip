function [ Cs, Cp1, Cp2 ] = microstripgapcap( epsr,g, h2, w1, w2)
...
C1 = sqrt(epseff(w1,h2,epsr))*microstripdeltaL(w1,h2,epsr)/(3e8 * microstripZ0_2(w1,h2,1));%open end capcitances
