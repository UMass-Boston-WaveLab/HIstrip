function [Admittance_WRT_distance] = AdmittanceAcrossEntireSlot_matrix(slot_2_x_dist, slot_1_x_dist, slot_seperation, frequency)
...
Admittance_WRT_distance = zeros(1, 1);
