function [Admittance] = AdmittanceAcrossEntireSlot_matrix(slot_2_x_dist, slot_1_x_dist, slot_1_y_dist, slot_2_y_dist, slot_seperation, frequency)
...
%THIS ACCEPTS PURELY WAVELENGTH DIMENSIONS (ELENGTH)
...
%The user can change this definitions to change the e-field from a constant
%distribution to a sinusoidal. An example of this field is given in the
%commented lines w/i the nested for-loop section below
...
%- Conversion between wavelengths. Another version exists that deals with
%non-wavelength (Admittacen..._mod.m)
end