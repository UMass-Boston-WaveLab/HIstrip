function [ Ym_near ] = HISantYmat_SS(w_ant1, h_ant1, L_ant1,eps1, w_sub, h_sub, L_sub,eps2, freq)
%% HISANTYMAT computes 4x4 mutual admittance matrix of equivalent radiating 

%My modifications to HISantYMat Function from GitHub
...
%% SELF ADMITTANCES Components used for Mutual Admittance
% Ys = Gs + jBs
