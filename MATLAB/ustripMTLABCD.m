...
cap = [C12+1/(1/C12+1/C2G), -C12; -C12, C2G]; %Symmetric; see MTL book for where this comes from --changed c11 value on April 24 2017
...
MTL = [A, (vpa(T)*sinh(vpa(gameig)*len)/vpa(T))/vpa(Yw); 
